...
if SERVER then
    ...
    -- resource.create("water", chip():getPos() + Vector(0, 20, 12), Angle(), 200, true)
    -- resource.create("gas", chip():getPos() + Vector(0, 20, 12), Angle(), 50, true)
    -- resource.create("rubber", chip():getPos() + Vector(0, -20, 12), Angle(), 100, true)
    -- resource.create("propellant", chip():getPos() + Vector(0, 0, 12), Angle(), 100, true)
