...
local mdl = model.new("mediumlight_vest", hitbox {
    ...
    :add("base", holo { ang = Angle(90, 0, 0), model = "models/holograms/cube.mdl", mesh = "armor", meshPart = "vest_medium_light", scale = Vector(1, 1.05, 0.9) } )
...
VestMediumLight.EquipOffset = Vector(-6, 3, 0)
VestMediumLight.EquipAngle = Vector(0, 90, 90)
VestMediumLight.EquipSlots = {[EquipSlot.chest] = 0.4, [EquipSlot.abdomen] = 0.3}
VestMediumLight.DefenseProfile = DefenseProfile.Basic
VestMediumLight.MaxDurability = 250
