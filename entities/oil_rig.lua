...
local mdl = model.new("oil_rig", part {
    ...
    holo { Vector(42, 0, 67), Angle(0, 0, 0), "models/props_silo/consolepanelloadingbay.mdl", Vector(1, 1, 1) },
    holo { Vector(36, 0, 96), Angle(0, 0, 0), "models/props/cs_office/tv_plasma.mdl", Vector(0.8, 0.8, 0.8) },
    holo { Vector(-108, -81, 10), Angle(90, 0, 0), "models/props_c17/canister_propane01a.mdl", Vector(1.8, 1.8, 3.5), clips = {{Vector(0, 0, 59.64), Vector(0, 0, -1)}} },
    holo { Vector(-108, 81, 10), Angle(90, 0, 0), "models/props_c17/canister_propane01a.mdl", Vector(1.8, 1.8, 3.5), clips = {{Vector(0, 0, 59.64), Vector(0, 0, -1)}} },
