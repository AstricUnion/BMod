...
if CLIENT then
    ...
    net.receive("BModCraftingTableOpen", function()
        net.readEntity(function(ent)
            ...
            local category = bgui.create("BPanel", tabs)
            local butt = bgui.create("BButton", category)
            local butt1 = bgui.create("BButton", category)
            butt:dock(bgui.DOCK.TOP)
            butt1:dock(bgui.DOCK.TOP)
            category:setZPos(category:getZPos() + 1)
            tabs:addSheet("test", category)
            local category2 = bgui.create("BPanel", tabs)
